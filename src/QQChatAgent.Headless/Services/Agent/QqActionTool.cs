...
/// 由 <c>BotAgent</c> 按任务构造 —— 不然模型只知道“给谁点赞”，不知道“给谁/在哪”。
/// </summary>
...
public sealed class SessionQqActionHost : IQqActionHost
{
    ...
    public SessionQqActionHost(OneBotGateway gateway, bool isGroup, long targetId, long senderId, long messageId, long selfId)
    {
        _gateway = gateway;
        _isGroup = isGroup;
        _targetId = targetId;
